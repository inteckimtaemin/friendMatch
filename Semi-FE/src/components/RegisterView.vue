	...
	<div class="RegisterView">
        ...
        <div class="forgot_account">
          <a @click="fnFindId" class="findId">아이디</a> 혹은 <a @click="fnFindPW" class="findPw">비밀번호</a>를 잊으셨나요?
			...
			<p class="buttons">
				<button @click.prevent="doSubmit()" class="button blue" name="SubmitButton" id="SubmitButton">가입하기</button>
...
export default {
	...
	methods : {
		doCancel() {
      console.log("doCancel Completed");
    ...
    doSubmit() {
      console.log("doSubmit Completed");
    }
	},
	mounted() {
		document.getElementById("memberEmailInput").focus();
